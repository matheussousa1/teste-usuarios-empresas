<?php
//https://github.com/DrHazemAli/PHP-Class-Anti-SQLInjection-Firewall/blob/master/Firewall.php
...
Class Firewall
  {
    public function SecureUris(){
         ...
         //    echo !preg_match("/^[_a-zA-Z0-9-=&]+$/", $securityUlrs_url);
         //    echo $securityUlrs_url != '';
         //    exit($this->SecurityWarningTemplate());
         // }
          return true;
      }
